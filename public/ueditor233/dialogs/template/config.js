...
var templates = [
    ...
    },
    {
        ...
        'preHtml':`
			    ...
			    <tbody>
			        <tr class="firstRow" style="width:100%">
			            <td style="border:1px solid #ddd; display:inline-block; width:16%; height:30px" valign="top"></td>
			            <td style="border:1px solid #ddd; display:inline-block; width:16%; height:30px" valign="top"></td>
			            <td style="border:1px solid #ddd; display:inline-block; width:16%; height:30px" valign="top"></td>
			            <td style="border:1px solid #ddd; display:inline-block; width:16%; height:30px" valign="top"></td>
			            <td style="border:1px solid #ddd; display:inline-block; width:16%; height:30px" valign="top"></td>
        ...
        'html':`
			    ...
			    <tbody>
			        <tr class="firstRow">
			            <td style="border:1px solid #ddd;" width="187" valign="top"></td>
			            <td style="border:1px solid #ddd;" width="187" valign="top"></td>
			            <td style="border:1px solid #ddd;" width="187" valign="top"></td>
			            <td style="border:1px solid #ddd;" width="187" valign="top"></td>
			            <td style="border:1px solid #ddd;" width="187" valign="top"></td>
			        ...
			        <tr>
			            <td valign="top" colspan="6" rowspan="1" style="text-align: left; vertical-align: middle;border:1px solid #ddd; background-color: #fff;"></td>
			        </tr>
			    </tbody>
			</table>
        `
